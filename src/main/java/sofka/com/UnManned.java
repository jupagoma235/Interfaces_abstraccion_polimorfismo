...
/**
 * Clase que representa las naves no tripuladas.
 * @author Juan Pablo Gonzalez Marin.
 */
public class UnManned extends Ship implements IShip {
    ...
    */
    ...
    public void Ship(int opcion) {
        switch (opcion){
            case 1:
                this.scopeoperationman="Termosfera a espacio exterior";
                break;
            default:
    ...
    public void Use(int option) {
        switch (option){
            case 1:
                ...
                break;
            case 2:                
                useman="Mantenimiento y corrección";
                break;       
            default:
                break;
        }        
    ...
    public void ChartCourse(String chartcourse) {
        if(!"".equals(this.scopeoperationman)){
           this.chartcourseman=chartcourse;
        }else{
